...
npm run verifier-cloisonnement   # 956 contrôles : la séparation formation / réel, et tout ce qui a été fermé
...
| **Doublons** : 12 règles écrites plusieurs fois ; A3/A4 (trois volets du dimensionnement) unifiés en 2.101.64 (`dimensionnement/devisCommun.js`), A10 (WhatsApp) en 2.101.76 (`lienWhatsApp` / `envoyerWhatsApp`, lib/core.js), A1/A2/A11/A12 (contrat, PV, plan signé) en 2.101.77 (`lib/contrat.js`), A5/A6/A7 (numéro de série, `memeContenu`, `lib/panier.js`) en 2.101.78, A8/A9 (`lib/prospects.js`, briques de pdf.js) en 2.101.79, B1/B4 (`demanderMoyenPaiement`, `demanderMois`, `demanderDate` dans ui.jsx) en 2.101.80 ; « lance tout » donné le 08/09 : la suite se fait point par point | À sa demande | `docs/doublons-2026-09.md` |
