...
export function EspaceClient({ db, profile, save, setTab }) {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* ⚠ 🔒 Mes données personnelles a QUITTÉ cet écran le 19/09/2026 :
          Timo l'a voulu en ONGLET à côté de 💬 Messages (screens/MesDonnees.jsx).
          Un panneau au bas d'un autre écran, c'était BMI qui montrait ; un
          onglet, c'est le client qui vient chercher — d'où « MES » données. */}
      <div className="text-xs text-slate-400">Utilisez l'onglet 💬 Messages pour écrire à nos équipes, et 🔒 Mes données pour voir ce que nous conservons à votre sujet.</div>
