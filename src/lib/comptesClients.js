...
// ---- 💬 LE MOT DE FIDÉLITÉ AU CLIENT ----
// Il part du numéro BMI, par les modèles `mot_fidelite` / `mot_fidelite_simple`
// (lib/whatsappModeles.js) : 📋 Clients depuis le 23/09/2026, 👥 Utilisateurs
// depuis le 25/09/2026. Le texte réglable de ⚙ Paramètres (16/09) a été
// RETIRÉ ce jour-là (décision « a ») : la phrase d'un modèle vit chez Meta,
// un réglage qui ne part plus chez le client ne commandait plus rien.

// « le vendeur », « l'administrateur » : l'ARTICLE est dans le rôle, pour que
// la phrase reste juste devant une voyelle (« celui de l'administrateur »,
// jamais « de le administrateur »). Sert au refus d'un identifiant déjà pris.
