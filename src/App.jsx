...
import {
  LOGO, uid, SEED, VERSION, PAIEMENTS, CATEGORIES, SALARIES, SALARIES_BOUTIQUE, PALETTE,
  COMPTE_TRESORERIE, COMPTE_CHARGE, normPaiement, lignesJournal,
  lignesVente, brutVente, qteVente, resumeArticles, totalVente,
  hacher, PBKDF2_ITERATIONS, genererSelHex, hacherFort, definirMotDePasse, verifierMotDePasse,
  prefixeBoutique, numeroRecu, fmt, today, dFR, telDigits, inP,
  COLORS, col, light, setColors,
} from "./lib/core";
import {
  Field, inputCls, btnDark, Badge, Panel, LoadingSpinner,
  uAlert, uConfirm, uPrompt, uChoix, DialogHost, PrintHost, ExportHost,
} from "./components/ui";
import {
...
import {
  imprimerRecu, imprimerProforma, imprimerBonRavitaillement, imprimerBulletin, recuWhatsApp,
  telechargerSauvegarde, NOM_FICHIER_AUTO, dossierDispo, ecrireDansDossier, exportCSV,
} from "./lib/impression";
...
function RechercheGlobale({ db, profile, onFermer, onNaviguer }) {
  const [texte, setTexte] = useState("");
...
function messagesNouveauClient(db, user, parQui) {
